...
import com.example.amazondemo.model.Cart;
import com.example.amazondemo.prevalent.Prevalent;
import com.example.amazondemo.viewHolder.CartViewHolder;
        ...
        FirebaseRecyclerOptions<Cart> options =
                new FirebaseRecyclerOptions.Builder<Cart>()
                        .setQuery(cartListRef.child("User View")
                                .child(Prevalent.currentUser.getEmail().substring(0,Prevalent.currentUser.getEmail().lastIndexOf('.')))
